...
--
--   Gestoría:    gestor@ejemplo.es        (entra por enlace mágico)
--   Empresa:     jefe@soldaduras.ejemplo  (entra por enlace mágico)
--   Trabajadores: código SOLDPER, PIN 482915 para los tres
--
...
INSERT INTO empleados (
  id, empresa_id, nombre, apellidos, documento_identidad, email, pin_hash,
  tipo_jornada, rol, dias_vacaciones_anuales, fecha_alta, fecha_baja, activo
) VALUES
  ('emp_ana', 'emc_dev', 'Ana', 'Ruiz Gómez', '12345678Z', NULL,
  ...
  ('emp_luis', 'emc_dev', 'Luis', 'Soto Marín', '87654321X', NULL,
   'pbkdf2$100000$a08473c9321b0d54fd84dc8e9fea4887$3a38c259ff739f40e4cd02955470f031b99b1389d132d99ab8b1d6e8ec53b02d',
   'completa', 'empleado', 22, '2026-01-02', NULL, 1),
  ('emp_marta', 'emc_dev', 'Marta', 'Ibáñez Cruz', '11223344W', NULL,
   'pbkdf2$100000$a08473c9321b0d54fd84dc8e9fea4887$3a38c259ff739f40e4cd02955470f031b99b1389d132d99ab8b1d6e8ec53b02d',
